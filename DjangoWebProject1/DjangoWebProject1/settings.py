...
SECRET_KEY = os.environ.get('SECRET_KEY', '7af95e61-c10b-4374-b477-8a6120cca632')

# SECURITY WARNING: don't run with debug turned on in production!cd
DEBUG = False
...
USE_YOOKASSA = (
    YOOKASSA_SHOP_ID != 'YOUR_SHOP_ID' and
